...
const RightColumn = ({ comment, isSubCreatedButNotYetPublished, settings, subplebbit, reset }: RightColumnProps) => {
  const { t } = useTranslation();
  ...
  const [showExpando, setShowExpando] = React.useState(false);
  ...
  return (
    <div className={styles.rightColumn}>
      ...
      >
        ...
        {(!(isMobile && isInHomeAboutView) || isInSubplebbitAboutView || isInPostPageAboutView) && <Version />}
